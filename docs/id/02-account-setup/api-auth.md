...
> 🇮🇩 Bahasa Indonesia | 🇬🇧 [English](../../en/02-account-setup/api-auth.md)
...
| Wrangler support | ✅ Yes | ❌ Wrangler v4+ butuh token |
...
# Harus muncul: success: true, email kamu, country, dll.
```
...
export CF_KEY="global_api_key_kamu"
...
❌ **DON'T:**
- Commit token ke Git (pakai `.gitignore` + secret scanner)
